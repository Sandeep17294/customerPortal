 ...
 * 
 * import org.apache.xmlbeans.impl.soap.Node; import org.w3c.dom.Document;
 * 
 * import requestdynamic.schemas.smsservice.ncis.art.ARTNCISDocument; import
 * requestdynamic.schemas.smsservice.ncis.art.ARTNCISDocument.ARTNCIS; import
 ...
 * try {
 * 
 * System.out.println("TEST SMS "); javax.xml.soap.SOAPMessage sms =
 * MessageFactory.newInstance ().createMessage (); javax.xml.soap.SOAPPart prt =
 * sms.getSOAPPart (); javax.xml.soap.SOAPEnvelope env =
 * (javax.xml.soap.SOAPEnvelope) prt.getEnvelope (); javax.xml.soap.SOAPBody bdy
 * = env.getBody ();
 * 
 * ARTNCISDocument art = ARTNCISDocument.Factory.newInstance();
 * 
 ...
 * 
 * Node nd = (Node) sms1.getDomNode(); javax.xml.soap.SOAPBodyElement ele =
